        ...
        <DialogContent className="sm:max-w-[425px]">
          <form
            onSubmit={(e) => {
              ...
              const workHr =
                Number((form.elements[0] as HTMLInputElement).value) || 0;
              const workMin =
              ...
              const breakMin =
                Number((form.elements[4] as HTMLInputElement).value) || 0;
              const breakSec =
                Number((form.elements[5] as HTMLInputElement).value) || 0;
          ...
          >
            <DialogHeader>
              ...
              <DialogDescription>
                Make changes to your pomodoro timer here. Click save when
                you&apos;re done.
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-4">
              <div className="grid gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>:</span>
                  <Input placeholder="mm" type="number" min={0} max={60} defaultValue={workMinutes}/>
                  <span>:</span>
                  <Input
                    placeholder="ss"
              ...
              <div className="grid gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>:</span>
                  <Input placeholder="mm" type="number" min={0} max={60} defaultValue={breakMinutes} />
                  <span>:</span>
                  <Input
                    placeholder="ss"
